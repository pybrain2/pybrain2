...
from pybrain2.structure.modules import BiasUnit, SigmoidLayer, LinearLayer, LSTMLayer
from pybrain2.structure.connections import FullConnection, IdentityConnection
